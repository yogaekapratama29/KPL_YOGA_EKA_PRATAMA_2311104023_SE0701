...
var getFn = _interopRequireWildcard(require("get-function-location"));
...
function _getValue() {
    _getValue = _asyncToGenerator(_regeneratorRuntime.default.mark(function _callee(param, argQueue, onCancel, cancledRef) {
        ...
        return _regeneratorRuntime.default.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 50:
                    ...
                    message = (0, _utils).camelCaseToHyphen(param.name);
...
function help(param) {
    ...
    return console.log((0, _dedent).default(_templateObject(), _kleur.default.gray("".concat(name, " ").concat(version)), _kleur.default.bold("Usage:"), name, _kleur.default.bold("Commands:"), (0, _utils).formatTable(commands.map(function(c) {
        return [
            c.name,
            c.description
        ];
    }), 6), _kleur.default.bold("Other commands:"), (0, _utils).formatTable([
        [
            "help",
            "",
...
function _swallowErrors() {
    _swallowErrors = _asyncToGenerator(_regeneratorRuntime.default.mark(function _callee(fn, onCancel) {
        return _regeneratorRuntime.default.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    _ctx.prev = 0;
                ...
                case 5:
                    ...
                    if (_ctx.t0 === "exit") {
                        ...
                        console.error(_kleur.default.red(_ctx.t0.message));
                    }
                case 8:
                case "end":
                    return _ctx.stop();
...
function _getFunctionData() {
    _getFunctionData = _asyncToGenerator(_regeneratorRuntime.default.mark(function _callee(data, fn) {
        ...
        return _regeneratorRuntime.default.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 5:
                    ...
                    file = loc.replace(_config.config.getOutputDir(), "").replace(/\.js$/, "").replace("file:///", "");
...
function run(dir, functions) {
    return _run.apply(this, arguments);
}
function _run() {
    _run = _asyncToGenerator(_regeneratorRuntime.default.mark(function _callee1(dir, functions) {
        ...
        return _regeneratorRuntime.default.wrap(function _callee$(_ctx1) {
            while(1)switch(_ctx1.prev = _ctx1.next){
                case 0:
                    ;
                    (0, _config).setRoot(dir);
                    _autocomplete.autocomplete.listen(functions);
                    _dir = dir;
                ...
                case 7:
                    pkgJson = _ctx1.sent;
                    _ctx1.next = 10;
                    return _config.config.getDataFile();
                case 10:
                    data = _ctx1.sent;
                    flags = [];
                ...
                case 22:
                    ...
                    _ctx1.next = 29;
                    return _autocomplete.autocomplete.uninstall();
                case 29:
                    return _ctx1.abrupt("return");
                case 32:
                    _ctx1.next = 34;
                    return _autocomplete.autocomplete.setup();
                case 34:
                    return _ctx1.abrupt("return");
                case 35:
                ...
                case 41:
                    ...
                    console.log(_kleur.default.gray("Check usage by running \"".concat(pkgJson.name, " help\"")));
                case 43:
                    if (!true) {
                        _ctx1.next = 52;
                        break;
                    ...
                    return (0, _prompts).default({
                        ...
                        choices: _toConsumableArray(Object.keys(functions).filter(function(name) {
                            ...
                            return {
                                title: (0, _utils).camelCaseToHyphen(key),
                                value: key
                            };
                        })),
                        onState: function() {
                            var _ref = _asyncToGenerator(_regeneratorRuntime.default.mark(function _callee(param) {
                                var value, d;
                                return _regeneratorRuntime.default.wrap(function _callee$(_ctx) {
                                    while(1)switch(_ctx.prev = _ctx.next){
                                        case 0:
                        ...
                        onRender: function onRender() {
                            ...
                            this.msg = [
                                "Select a command",
                                helpText ? _kleur.default.gray("(".concat(helpText, ")")) : null, 
                            ].filter(Boolean).join(" ");
                        }
                    }, {
                        onCancel: exit
                ...
                case 47:
                    ...
                    _ctx1.next = 50;
                    return swallowErrors(_asyncToGenerator(_regeneratorRuntime.default.mark(function _callee() {
                        return _regeneratorRuntime.default.wrap(function _callee$(_ctx) {
                            while(1)switch(_ctx.prev = _ctx.next){
                                case 0:
                                    _ctx.next = 2;
...
function runInternal(dir, fns, functionName) {
    return _runInternal.apply(this, arguments);
}
function _runInternal() {
    _runInternal = _asyncToGenerator(_regeneratorRuntime.default.mark(function _callee(dir, fns, functionName) {
        ...
        return _regeneratorRuntime.default.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 6:
                    ...
                    _ctx.next = 12;
                    return require(_path.default.join(dir, "./cli.json"));
                case 12:
                    data = _ctx.sent;
                    command = (0, _utils).hyphenToCamelCase(functionName);
                    fn = fns[command];
                    if (!(!command || !fn)) {
                        _ctx.next = 48;
                        break;
                ...
                case 25:
                    ...
                    if (functionData) {
                        ;
                        commands.push({
                            name: (0, _utils).camelCaseToHyphen(name1),
