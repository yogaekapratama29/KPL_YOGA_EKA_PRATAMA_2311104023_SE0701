import regeneratorRuntime1 from "regenerator-runtime";
// @ts-ignore
...
function _crawlRecursive() {
    _crawlRecursive = _asyncToGenerator(regeneratorRuntime1.mark(function _callee(entry) {
        ...
        return regeneratorRuntime1.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 4:
                    ...
                    _ctx.prev = 7;
                    _ctx.next = 10;
                    return fs.readFile(entry + ".ts", "utf8");
                case 10:
                    data = _ctx.sent;
                    _ctx.next = 16;
                    break;
                ...
                case 22:
                    ...
                    importedFilePath = path.join(dir, importedFile);
                    _ctx.next = 31;
...
function _crawl() {
    _crawl = _asyncToGenerator(regeneratorRuntime1.mark(function _callee(entry) {
        var visited;
        return regeneratorRuntime1.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
...
function _buildTypeScript() {
    _buildTypeScript = _asyncToGenerator(regeneratorRuntime1.mark(function _callee(tmpBuiltPath) {
        ...
        return regeneratorRuntime1.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                ...
                case 2:
                    ts = _ctx.sent.ts;
                    _ctx.next = 5;
                    return fs.writeFile(tmpBuiltPath, dedent(_templateObject(), config.packageName));
                case 5:
                    try {
                        emitSpinner = createSpinner("Emitting CLI build");
                        ...
                        fs.rename(path.join(config.getOutputDir(), tmpBuiltPath), path.join(config.getOutputDir(), "cli.js"));
                        emitSpinner.success();
                    } catch (e) {
                        console.log(e);
                        // cleanup
...
function _buildCli() {
    _buildCli = _asyncToGenerator(regeneratorRuntime1.mark(function _callee() {
        var Project, detectingTypesspinner, project, files, functions, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, path1, file, _key, key1, fns, definitions, buildParamTypes, cli, warning, file1, _iteratorNormalCompletion1, _didIteratorError1, _iteratorError1, _iterator1, _step1, fn1, ref, name1, ref3, ref4, matchingFnExportName, matchingFn, ref5, description, params, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, param1, writingFileSpinner;
        return regeneratorRuntime1.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                ...
                case 3:
                    ...
                    detectingTypesspinner = createSpinner("Detecting CLI commands").start();
                    project = new Project({
                        compilerOptions: {
                            outDir: "dist",
                            declaration: true,
                ...
                case 13:
                    ...
                    path1 = _step.value;
                    project.addSourceFilesAtPaths(path1);
                    file = project.getSourceFile(path1);
                    if (file) {
                        _ctx.next = 21;
                        break;
                    }
                    {
                        console.error(kleur.red("".concat(path1, " does not exsist")));
                    }
                    _ctx.next = 28;
                    break;
                case 21:
                    ;
                    key1 = path1.replace(config.cliRoot, "").replace(/\.ts/, "");
                    if (!functions[key1]) {
                        _ctx.next = 25;
                        break;
                    }
                ...
                case 45:
                    ...
                    ;
                    _ctx.next = 49;
                    return require(config.getJsEntry());
                case 49:
                    cli = _ctx.sent.cli;
                    warning = false;
                ...
                case 57:
                    ...
                    warning = true;
                    console.warn(kleur.yellow("Warning: CLI functions must be named functions"));
                ...
                case 65:
                    ...
                    warning = true;
                    console.warn("\n" + kleur.yellow(dedent(_templateObject1(), kleur.bold("Correct"), name1, name1, kleur.bold("Incorrect"), name1, matchingFnExportName, name1)));
                    return _ctx.abrupt("continue", 93);
                case 71:
                    ;
                ...
                case 112:
                    if (warning) {
                        ...
                        detectingTypesspinner.success({
                            mark: kleur.yellow(symbols.tick)
                        });
                    } else {
                        detectingTypesspinner.success();
                    }
                    writingFileSpinner = createSpinner("Writing CLI data files").start();
                    _ctx.next = 116;
                    return fs.writeFile(path.join(config.getOutputDir(), "cli.json"), JSON.stringify(definitions, null, 2));
                case 116:
...
function _build() {
    _build = _asyncToGenerator(regeneratorRuntime1.mark(function _callee() {
        var tmpBuiltPath;
        return regeneratorRuntime1.wrap(function _callee$(_ctx) {
            while(1)switch(_ctx.prev = _ctx.next){
                case 0:
                    _ctx.prev = 0;
                    _ctx.next = 3;
                    return fs.mkdir(config.getOutputDir(), {
                        recursive: false
                    });
                case 3:
                    _ctx.next = 7;
